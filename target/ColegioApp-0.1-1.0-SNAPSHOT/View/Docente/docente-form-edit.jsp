...
<html>
  <%@ include file="/View/Container/head.jsp" %>
   ...
   <div class="main col-10 h-100 py-3">            
        ...
        <form action="${pageContext.request.contextPath}/Docente?action=update" method="post">     
      
            <div class="mb-3">
                <label for="dni" class="form-label">DNI</label>
                <input type="text" name="dni" value="${docente.dni}" autocomplete="off" class="form-control"/>            
            ...
            <div class="mb-3">
                ...
                <input type="text" name="apellidoPaterno" value="${docente.apellido_paterno}" autocomplete="off" class="form-control"/> 
            ...
            <div class="mb-3">
                ...
                <input type="text" name="apellidoMaterno" value="${docente.apellido_materno}" autocomplete="off" class="form-control"/>            
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombres" value="${docente.nombres}" autocomplete="off" class="form-control"/>            
            ...
            <div class="mb-3">
                ...
                <input type="text" name="contacto" id="contacto" value="${docente.contacto}" class="form-control">            
            ...
            <input type="hidden" name="id" value="${docente.docente_id}">
