...
<!--            <form action="${pageContext.request.contextPath}/AsistenciaDocentes?action=insertIngreso" method="post" >
                <div>
                    <div class="alinear">
                        <div>
                        ...
                        <button class="button1 btn2" type="submit" value="Ingreso">
                ...
                <div class="alinear">    
                    ...
                    <form action="${pageContext.request.contextPath}/AsistenciaDocentes?action=insertSalida" method="post" >
                        <div>
