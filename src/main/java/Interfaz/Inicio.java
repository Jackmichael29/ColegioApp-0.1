...
public class Inicio extends javax.swing.JFrame {
    ...
    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
        ...
        try {
            ...
            switch (columna) {
                case 2 :
                    alumno.setDni(datoNuevo);
                    break;
                case 3 :
                    alumno.setApellido_paterno(datoNuevo);
                    break;
                case 4 :
                    alumno.setApellido_materno(datoNuevo);
                    break;
                case 5 :
                    alumno.setNombres(datoNuevo);
                    break;
                case 6 :
                    alumno.setFecha_nacimiento(Date.valueOf(datoNuevo).toLocalDate() );
                    break;
                case 7 :
                    alumno.setCorreo_electrico(datoNuevo);
                    break;
                default :
                    break;
            }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        try {
            ...
            switch (columna) {
                case 2 :
                    apoderado.setDni(datoNuevo);
                    break;
                case 3 :
                    apoderado.setApellido_paterno(datoNuevo);
                    break;
                case 4 :
                    apoderado.setApellido_materno(datoNuevo);
                    break;
                case 5 :
                    apoderado.setNombres(datoNuevo);
                    break;
                case 6 :
                    apoderado.setContacto(datoNuevo);
                    break;
                default :
                    break;
            }
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        try {
            ...
            switch (columna) {
                case 2 :
                    docente.setDni(datoNuevo);
                    break;
                case 3 :
                    docente.setApellido_paterno(datoNuevo);
                    break;
                case 4 :
                    docente.setApellido_materno(datoNuevo);
                    break;
                case 5 :
                    docente.setNombres(datoNuevo);
                    break;
                case 6 :
                    docente.setContacto(datoNuevo);
                    break;
                default :
                    break;
            }
