...
public class MantenimientoController extends HttpServlet {
    ...
    static final String PATH_MANTENIMIENTO="/View/Container/mantenimiento.jsp"; 
    ...
    throws SQLException, IOException, Exception {
        ...
        getServletContext().getRequestDispatcher(PATH_MANTENIMIENTO).forward(request, response);
