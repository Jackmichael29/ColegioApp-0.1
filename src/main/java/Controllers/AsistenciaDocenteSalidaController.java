 ...
 * @author walter
 */
@WebServlet("/AsistenciaDocentesSalida")
public class AsistenciaDocenteSalidaController extends HttpServlet {
 

    //static final String PATH_FORM_NEW="/View/Matricula/matricula-form-new.jsp";
    static final String PATH_FORM_EDIT="/View/AsistenciaDocentes/salidaDocentes.jsp";
    ...
    static final String PATH_LIST_COURSE="/View/AsistenciaDocentes/salidaDocentes.jsp";
        ...
        if(usuario.isBlank() || contrasena.isBlank()){
            ...
            if (u == null) {
                ...
                if (u.getClave().equals(enc.Encriptar(contrasena))) {
                    ...
                    if (interno != null) {
                        if (interno.getHora_salida() == null) {
                            Time timecito = Time.valueOf(LocalTime.now());
                            asisdocbo.insertarSalida(interno.getDocente_id(), LocalDate.now(), timecito);
                        } else {
                            errores.put("usuario", "El usuario ya registro su salida");
                        }
                    } else {
                        errores.put("usuario", "El usuario no registro su ingreso, por tanto, no puede registrar su salida");
                    }
                }else {
