 ...
 * @author walter
 */
@WebServlet("/AsistenciaDocentesIngreso")
public class AsistenciaDocenteIngresoController extends HttpServlet {
 

    //static final String PATH_FORM_NEW="/View/Matricula/matricula-form-new.jsp";
    static final String PATH_FORM_EDIT="/View/AsistenciaDocentes/ingresoDocentes.jsp";
    ...
    static final String PATH_LIST_COURSE="/View/AsistenciaDocentes/ingresoDocentes.jsp";
