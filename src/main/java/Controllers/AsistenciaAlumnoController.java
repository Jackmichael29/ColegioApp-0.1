...
public class AsistenciaAlumnoController extends HttpServlet {
    ...
    static final String PATH_FORM_EDIT="/View/AsistenciaAlumnos/asistenciaAlumnos.jsp";
    static final String PATH_RESULT="/View/AsistenciaAlumnos/nota-result.jsp";
    static final String PATH_FORM_REPORT="/View/Reportes/ReporteNotasPorAula.jsp"; 
    static final String PATH_LIST_COURSE="/View/AsistenciaAlumnos/asistenciaAlumnos.jsp";
    ...
    throws SQLException, IOException, Exception {
        ...
        ArrayList<Alumno> hnotas = aBO.buscarPorGradoNivel(grado, nivel);
        
        LocalDate fecha = LocalDate.now();
        request.setAttribute("hnotas", hnotas);
